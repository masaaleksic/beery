...
export default function Contact() {
    return (
        <>
            ...
            <div className="d-flex justify-content-center flex-wrap text-center pb-5 mt-5">
                <div className="contact-layout me-2 d-flex align-items-center">
                    <div>
                        <img src={Phone}/>
                ...
                <div className="ms-2 mt-5 mt-md-0">
                    <iframe
